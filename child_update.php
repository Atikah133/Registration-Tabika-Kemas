...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE child SET name='$name', age='$age', citizen='$citizen', race='$race', date_of_birth='$date_of_birth',birth_certificate_no='$birth_certificate_no',
            place_of_birth='$place_of_birth',gender='$gender',address='$address',shirt_size='$shirt_size',disease='$disease',high='$high',weight='$weight',allergies='$allergies',
            disability='$disability',contact_name='$contact_name',contact_address='$contact_address',contact_phone='$contact_phone',relationship='$relationship' WHERE child_id='$child_id'";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Information updated successfully'); window.location.href = 'child_read.php';</script>";
    } else {
...
<div class="container-md">
            ...
            <div id="Create" class="tabcontent">
                <form action="child_update.php" method="POST" class="row g-3">
                        ...
                        <fieldset class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="shirt_size" id="gridRadios1" value="option1">
                                    <label class="form-check-label" for="gridRadios1">
                                        S
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="shirt_size" id="gridRadios2" value="option2">
