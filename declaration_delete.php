<?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "DELETE FROM declaration WHERE declaration_id='$declaration_id'";

            if ($conn->query($sql) === TRUE) {
                echo "<script>alert('Information deleted successfully'); window.location.href = 'declaration_read.php';</script>";
            } else {
    ...
    <div class="container-md">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="declaration_read.php">View</a></li>
            ...
            <div id="Create" class="tabcontent">
                <form action="declaration_delete.php" method="POST" class="row g-3">
                <h3>File Upload</h3>
                        <div class="col-md-10">
                            <label for="declaration_id">Declaration ID:</label>
                            <input type="number" id="declaration_id" name="declaration_id" required><br><br>
                        </div>
                        <div class="col-md-6">
